...
function downloadForecast(url) {
    $.getJSON(url, function (data) {
        ...
        Condition - forecast[i].day.condition.icon - returns a url
        High - forecast.day.maxtemp_c
        Low - forecast.day.mintemp_c
        Wind - forecast.day.maxwind_kph
        Outlook - forecast.day.condition.text
        */
        ...
        for (let i = 0; i < forecast.length; i++) {
            ...
            contents = $("<tr><td scope = \"row\>"+ forecast[i].date + "</td></tr>");
            //"<td><img src="+day.icon+"></img>"+"</td>"+
            //"</tr>");
